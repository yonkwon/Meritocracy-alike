...
set_fig1_number <- 1
set_fig1_outcome <- data$r.o1.avg
set_fig1_outcome_std <- data$r.o1.std
set_fig1_t <- 1
...
# set_fig1_number <- 2
# set_fig1_outcome <- data$r.01.avg + data$r.11.avg
# set_fig1_t <- 101
# set_fig1_outcome <- set_fig1_outcome[set_decision_rule_id, set_dp_id, set_du_id, , , set_fig1_t] * 100
# set_fig1_outcome_label <- paste0('Organization\'s Tendency to\nChoose Female Arm at t=',set_fig1_t-1)
# set_fig1_hline = mean(data$r.10.avg[1, set_dp_id, set_du_id, , 1] + data$r.11.avg[1, set_dp_id, set_du_id, , , 1]) * 100
# set_fig1_hline_label = 'Solo Woman, No Learning'

# set_fig1_number <- 3
# set_fig1_outcome <- data$r.f1.avg * 100
# set_fig1_outcome_std <- data$r.f1.std * 100
# set_fig1_t <- 101
...
for( dr in 1:length(set_decision_rule_id) ){
  for( g in 1:data$para.g.g ){
    df_next <- data.frame(
      ...
      y_min = 75,
      y_max = 100,
      ci_min = set_fig1_outcome[dr,,g] - set_fig1_outcome_std[dr,,g] / sqrt(data$para.iteration),
      ci_max = set_fig1_outcome[dr,,g] + set_fig1_outcome_std[dr,,g] / sqrt(data$para.iteration),
...
fig1 <- fig1 +
  ...
  scale_shape_manual(values=dms_shape) +
...
fig1_params_label <- paste0(
  ...
  'dp', data$para.a.dp[set_dp_id],
  'du', data$para.a.du[set_du_id],
  'g', data$para.a.g[set_g],
  't', set_fig1_t
)
...
set_fig4_hline = mean(data$r.10.avg[1, set_dp_id, set_du_id, , set_g, 1] + data$r.11.avg[1, set_dp_id, set_du_id, , set_g, 1]) * 100
...
for( dr in 1:length(set_decision_rule_id) ){
  df_next <- data.frame(
    dr = dms_label_2l[set_decision_rule_id[dr]],
    color = dms_color[dr],
...
set_figa_female_id <- data$para.a.m
...
dms_label_adjust <- paste0(dms_label, ifelse(set_w_learning_figa, '\nwith Postjoin Learning', '\nwithout Postjoin Learning'))
dms_label_adjust <- factor(dms_label_adjust, levels = dms_label_adjust)

for( dp_id in set_dp_id ){
  panel_index <- panel_index+1
  for( dr in set_decision_rule_id){
    share_00 <- data$r.00.avg[dr, dp_id, set_du_id, , set_t_figa_grand]
    share_01 <- data$r.01.avg[dr, dp_id, set_du_id, , set_t_figa_grand]
    share_10 <- data$r.10.avg[dr, dp_id, set_du_id, , set_t_figa_grand]
    share_11 <- data$r.11.avg[dr, dp_id, set_du_id, , set_t_figa_grand]
    
    outcome_freq <- share_10+share_11
    # outcome_freq <- share_11
    df_next <- data.frame(
      panel_label = panel_label[panel_index],
      dr = dms_label_adjust[dr],
      y_min = 75,
      y_max = 100,
      # y_hline_wo = mean(data$r.10.avg[dr, dp_id, set_du_id, , 1] + data$r.11.avg[dr, dp_id, set_du_id, , 1])*100,
      # y_hline_w = mean(data$r.10.avg[dr, dp_id, set_du_id, , set_t_figa_grand] + data$r.11.avg[dr, dp_id, set_du_id, , set_t_figa_grand])*100,
      y_hline_wo = mean(data$r.10.avg[1, dp_id, set_du_id, , 1] + data$r.11.avg[1, dp_id, set_du_id, , 1])*100,
      y_hline_w = mean(data$r.10.avg[1, dp_id, set_du_id, , set_t_figa_grand] + data$r.11.avg[1, dp_id, set_du_id, , set_t_figa_grand])*100,
...
figa_grand <- get_figa_grand(
  filename = paste0(
    'figa_grand_',
    'dr', paste0(set_decision_rule_id, collapse = ","),
    'dp', paste0(data$para.a.dp[set_dp_id], collapse = ","),
    'du', data$para.a.du[set_du_id],
    't', set_t_figa_grand
  ),
  axes = axes, 
...
dms_label_adjust <- paste0(dms_label, ifelse(set_w_learning_figd, '\nwith Postjoin Learning', '\nwithout Postjoin Learning'))
dms_label_adjust <- factor(dms_label_adjust, levels = dms_label_adjust)

for( dp_id in set_dp_id ){
  panel_index <- panel_index+1
  for( dr in set_decision_rule_id){
    share_cs <- data$r.cs.shr[dr, dp_id, set_du_id, , set_t_figd_grand]
    share_c0 <- data$r.c0.shr[dr, dp_id, set_du_id, , set_t_figd_grand]
    share_c1 <- data$r.c1.shr[dr, dp_id, set_du_id, , set_t_figd_grand]
    ...
    df_next <- data.frame(
      ...
      y_min = 0,
      y_max = 100,
      y_hline = mean(data$r.c0.shr[dr, dp_id, set_du_id, , 1])*100,
      p_label = p_label[dp_id],
      composition = composition_label,
      outcome_label = outcome_label[1],
      outcome_freq = outcome_freq * 100,
    ...
    df_next <- data.frame(
      ...
      y_min = 0,
      y_max = 100,
      y_hline = mean(data$r.c1.shr[dr, dp_id, set_du_id, , 1])*100,
      p_label = p_label[dp_id],
      composition = composition_label,
      outcome_label = outcome_label[2],
      outcome_freq = outcome_freq * 100,
...
dms_label_adjust <- paste0(dms_label, ifelse(set_w_learning_fige, '\nwith Postjoin Learning', '\nwithout Postjoin Learning'))
dms_label_adjust <- factor(dms_label_adjust, levels = dms_label_adjust)

for( dp_id in set_dp_id ){
  panel_index <- panel_index+1
  for( dr in set_decision_rule_id){
    share_mc <- data$r.mc.shr[dr, dp_id, set_du_id, , set_t_fige_grand]
    ...
    df_next <- data.frame(
      ...
      y_min = 75,
      y_max = 100,
      y_hline = mean(data$r.mc.shr[dr, dp_id, set_du_id, , 1])*100,
      p_label = p_label[dp_id],
      composition = composition_label,
      outcome_label = outcome_label[1],
      outcome_freq = outcome_freq * 100,
...
for( dp_id in set_dp_id ){
  panel_index <- panel_index+1
  for( dr in set_decision_rule_id){
    share_c0 <- data$r.c0.avg[dr, dp_id, set_du_id, , set_t_figd_grand]
    share_c1 <- data$r.c1.avg[dr, dp_id, set_du_id, , set_t_figd_grand]
    ...
    df_next <- data.frame(
      ...
      y_min = 75,
      y_max = 100,
      y_hline = mean(data$r.10.avg[dr, dp_id, set_du_id, , 1] + data$r.11.avg[dr, dp_id, set_du_id, , 1])*100,
      p_label = p_label[dp_id],
      composition = composition_label,
      outcome_label = outcome_label[1],
      outcome_freq = outcome_freq * 100,
...
du_label <- c(
  paste0('DU=', data$para.a.du[1], ' (Indifferent Preference)'),
  paste0('DU=', data$para.a.du[2], ' (Different Preference)'),
  paste0('DU=', data$para.a.du[3], ' (Very Diffrent Preference)')
)
...
for( du_id in set_du_id ){
  panel_index <- panel_index+1
  for( dr in set_decision_rule_id){
    share_00 <- data$r.00.avg[dr, set_dp_id, du_id, , set_t_figa_grand]
    share_01 <- data$r.01.avg[dr, set_dp_id, du_id, , set_t_figa_grand]
    share_10 <- data$r.10.avg[dr, set_dp_id, du_id, , set_t_figa_grand]
    share_11 <- data$r.11.avg[dr, set_dp_id, du_id, , set_t_figa_grand]
    ...
    df_next <- data.frame(
      ...
      y_min = 75,
      y_max = 100,
      y_hline = mean(data$r.10.avg[dr, set_dp_id, du_id, , 1] + data$r.11.avg[dr, set_dp_id, du_id, , 1])*100,
...
figa_grand <- get_figa_grand(
  filename = paste0(
    'figa_grand_',
    'dr', paste0(set_decision_rule_id, collapse = ","),
    'du', paste0(data$para.a.du[set_du_id], collapse = ","),
    'dp', data$para.a.dp[set_dp_id],
    't', set_t_figa_grand
  ),
  axes = axes, 
...
decision_rule_label <- dms_label[set_decision_rule_id]
...
for( dp_id_id in 1:length(set_dp_id) ){
  for( dms_id in 1:length(set_decision_rule_id) ){
    dr <- set_decision_rule_id[dms_id]
    dp_id <- set_dp_id[dp_id_id]
    panel_index <- dp_id_id + (dms_id-1)*3
    
    # No Postjoin Learning
    share_00 <- data$r.00.avg[dr, dp_id, set_du_id, , 1]
    share_01 <- data$r.01.avg[dr, dp_id, set_du_id, , 1]
    share_10 <- data$r.10.avg[dr, dp_id, set_du_id, , 1]
    share_11 <- data$r.11.avg[dr, dp_id, set_du_id, , 1]
    ...
    df_next <- data.frame(
      ...
      outcome_label = outcome_label[2],
      learning_label = learning_label[1],
      ol_label = ol_label[(dms_id-1) * 2 + 1],
      outcome_freq = outcome_freq * 100,
      outcome_freq_rnd = ifelse(outcome_freq*100>3,round(outcome_freq*100),'')
    )
    df_figc_grand <- rbind(df_figc_grand, df_next)
    ...
    # Postjoin Learning
    share_00 <- data$r.00.avg[dr, dp_id, set_du_id, , set_t_figc_grand]
    share_01 <- data$r.01.avg[dr, dp_id, set_du_id, , set_t_figc_grand]
    share_10 <- data$r.10.avg[dr, dp_id, set_du_id, , set_t_figc_grand]
    share_11 <- data$r.11.avg[dr, dp_id, set_du_id, , set_t_figc_grand]
    ...
    df_next <- data.frame(
      ...
      outcome_label = outcome_label[2],
      learning_label = learning_label[2],
      ol_label = ol_label[(dms_id-1) * 2 + 2],
      outcome_freq = outcome_freq * 100,
      outcome_freq_rnd = ifelse(outcome_freq*100>3,round(outcome_freq*100),'')
    )
    df_figc_grand <- rbind(df_figc_grand, df_next)
...
get_figc_grand <- function(
  ...
  fig <- ggplot(alpha = fig_alpha, data = dat, mapping = axes) +
    facet_grid(dms_label~p_label, scales = 'free_y', switch='y') +
...
for( dp_id in set_dp_id ){
  panel_index <- panel_index+1
  for( dr in set_decision_rule_id){
    utility <- data$r.ut.avg[dr, dp_id, set_du_id, , set_t_figd_util]
    df_next <- data.frame(
      panel_label = panel_label[panel_index],
      dr = dms_label_adjust[dr],
      p_label = p_label[dp_id],
...
# figa 
for( dr in set_decision_rule_id){
  share_00 <- data$r.00.avg[dr, set_dp_id, set_du_id, , set_t_figa]
  share_01 <- data$r.01.avg[dr, set_dp_id, set_du_id, , set_t_figa]
  share_10 <- data$r.10.avg[dr, set_dp_id, set_du_id, , set_t_figa]
  share_11 <- data$r.11.avg[dr, set_dp_id, set_du_id, , set_t_figa]
  df_next <- data.frame(
    label = dms_label[dr],
      composition = rep(composition_label, length(outcome_label)),
      outcome = rep(outcome_label, each = data$para.g.m),
      outcome_freq = c(
...
df_figa$label <- factor(df_figa$label, levels=dms_label)
...
# figb 
for( dr in set_decision_rule_id){
  share_00 <- data$r.00.avg[dr, set_dp_id, set_du_id, , set_t_figb]
  share_01 <- data$r.01.avg[dr, set_dp_id, set_du_id, , set_t_figb]
  share_10 <- data$r.10.avg[dr, set_dp_id, set_du_id, , set_t_figb]
  share_11 <- data$r.11.avg[dr, set_dp_id, set_du_id, , set_t_figb]
  outcome_freq <- share_10+share_11
  df_next <- data.frame(
    label = dms_label[dr],
    composition = composition_label,
...
df_figb$label <- factor(df_figb$label, levels=dms_label)
...
# figc 
for( dr in set_decision_rule_id){
  share_00 <- data$r.00.avg[dr, set_dp_id, set_du_id, , set_t_figc]
  share_01 <- data$r.01.avg[dr, set_dp_id, set_du_id, , set_t_figc]
  share_10 <- data$r.10.avg[dr, set_dp_id, set_du_id, , set_t_figc]
  share_11 <- data$r.11.avg[dr, set_dp_id, set_du_id, , set_t_figc]
  outcome_freq <- share_01+share_11
  df_next <- data.frame(
    label = dms_label[dr],
    composition = composition_label,
...
df_figc$label <- factor(df_figc$label, levels=dms_label)
...
```{r fig4}
set_t_range_fig6 <- 1:data$para.time
set_dms_id <- 1:4
set_dp_id <- 3
set_du_id <- 2
set_m_id <- 3
...
df_fig6 <- data.frame()
# fig6 
for( dr in set_dms_id){
  df_next <- data.frame(
    label_x = dms_label[dr],
    ...
    outcome_value = c(data$r.fp.avg[dr, set_dp_id, set_du_id, set_m_id, set_t_range_fig6, c(1,data$para.a.m[set_m_id]), ])
  )
  ...
  df_next <- data.frame(
    ...
    time = rep(set_t_range_fig6, length(outcome_label)),
    outcome = rep(outcome_label, each = length(set_t_range_fig6)),
    outcome_value = c(data$r.fn.avg[dr, set_dp_id, set_du_id, set_m_id, set_t_range_fig6, c(1,data$para.a.m[set_m_id]), ])
  )
  df_fig6 <- rbind(df_fig6, df_next)
}
...
fig6 <- get_fig_6(
  filename = paste0(
    'fig6',
    'p', data$para.a.dp[set_dp_id],
    'du', data$para.a.du[set_du_id],
    'm', data$para.a.m[set_m_id],
    'm1', data$para.a.m1[set_m_id]
  ),
...
```{r tail}
data$r.ci.avg[3, 3, 2, 4, 100, , ]
data$r.ci.avg[3, 4, 2, 4, 100, , ]
